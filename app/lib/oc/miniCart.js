...
function minicart() {
    ...
    function template(){
        return [
            '<style>',
            '.minicart { padding: 15px 15px 15px 0; float: right; cursor: pointer;color: #4e2683; min-width:300px; text-align:right;}',
            ...
            '.minicart .label.label-default {border-top-right-radius: 0;border-top-left-radius: 0;border-bottom-right-radius: 0;border-bottom-left-radius: 0;background-color: #4e2683;}',
            ...
            '.minicart .minicart-detail .fa-caret-down {color: #4e2683;}',
            ...
            '</style>',
            '<div ng-show="cartCount">',
            '    <div class="minicart">',
            '        <i class="fa fa-shopping-cart"></i> <span class="label label-default">{{cartCount + \' ITEM(S)\'}}</span> <span class="hidden-xs"> - {{currentOrder.Total | currency }}</span> <i class="fa fa-caret-down"></i>',
